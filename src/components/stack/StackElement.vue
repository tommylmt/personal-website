    ...
    <div class="item grid-stack-item">
        <div class="grid-stack-item-conten">
            <div :class="[
                ...
                <div
                    v-html="icon.svg"
                    class="transition-all w-7/12 mx-auto fill-slate-300 group-hover:fill-slate-400 dark:fill-slate-600"
                ></div>
                <p class="font-sans text-xs text-slate-400 mt-5 dark:text-slate-600">{{ icon.title }}</p>
            </div>
        </div>
    </div>
</template>
