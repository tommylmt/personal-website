<template>
    ...
    >
        ...
        <div
            :class="[
                'absolute transition-all duration-200 content bg-white/90 backdrop-blur-md p-5 rounded-2xl w-[96%] left-[2%] -bottom-[200px] -xl:bottom-[160px] group-hover:bottom-2 dark:bg-neutral-950/80',
                { 'bottom-2': isExpanded }
            ]"
        >
            <slot></slot>
